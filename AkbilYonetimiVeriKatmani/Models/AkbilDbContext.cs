...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MONSTER; Database=AkbilDB; Integrated Security=True;Encrypt=True;TrustServerCertificate=True;Trusted_Connection=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Akbiller>(entity =>
        {
            entity.HasKey(e => e.AkbilNo).HasName("PK__Akbiller__ADBC6456F2DCF8BB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Kullanic__3214EC0723C1CE51");
        ...
        modelBuilder.Entity<KullanicininTalimatlari>(entity =>
        {
            ...
            entity.Property(e => e.Akbil).HasMaxLength(72);
            entity.Property(e => e.YuklenecekTutar).HasColumnType("decimal(18, 2)");
        });

        modelBuilder.Entity<Talimatlar>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Talimatl__3214EC07D35D20BC");
